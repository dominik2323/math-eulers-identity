...
})({"b9tJq":[function(require,module,exports) {
...
class Euler {
    constructor(conainerId){
        ...
        this.steps = 2000;
        this.iterations = 50;
        new (0, _sliderDefault.default)(0, 20 * PI, 0.01, this.x, (v)=>this.x = v);
        new (0, _sliderDefault.default)(0, 20 * PI, 0.01, this.y, (v)=>this.y = v);
        new (0, _sliderDefault.default)(1, 2000, 1, this.steps, (v)=>this.steps = v);
        new (0, _sliderDefault.default)(0, 100, 1, this.iterations, (v)=>this.iterations = v);
        this.render();
    }
    ...
    euler(x, y, n, colorMultipler = 1) {
        ...
        this.drawPoint(xr, yi, `rgba(${255 * colorMultipler}, ${255 * (1 - colorMultipler)}, ${255 * (1 - colorMultipler)}, 1)`);
    }
    render(t) {
        this.time = t || 0;
        ...
        this.canvasCtx.translate(innerWidth / 2, innerHeight / 2);
        for(let i = 1; i <= this.steps; i++)this.euler(this.x * i / this.steps / o, this.y * i / this.steps, this.iterations, i / this.steps * o);
        requestAnimationFrame(this.render.bind(this));
    }
}
new Euler("container");

},{"@parcel/transformer-js/src/esmodule-helpers.js":"esnmy","./slider":"4ert0"}],"esnmy":[function(require,module,exports) {
...
},{}],"4ert0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"esnmy"}]},["b9tJq","2iQTb"], "2iQTb", "parcelRequire94c2")
